...
enum InternetConnectionType {
    ...
    INTERNET_CONNECTION_WLAN,
    INTERNET_CONNECTION_2G,
    INTERNET_CONNECTION_3G,
    INTERNET_CONNECTION_4G,
    INTERNET_CONNECTION_CDMA2000,
    INTERNET_CONNECTION_WCDMA,
    INTERNET_CONNECTION_HSPA,
    INTERNET_CONNECTION_BLUETOOTH,
    INTERNET_CONNECTION_WIMAX,
    INTERNET_CONNECTION_EVDO,
    INTERNET_CONNECTION_LTE
};
